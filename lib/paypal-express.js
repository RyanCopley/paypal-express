...
PaypalExpress.prototype.beginInstantPayment = function (invoiceNumber, transactionId, options, callback) {
    //Set required request parameters
    options['METHOD'] = 'SetExpressCheckout';
    options['PAYMENTREQUEST_0_INVNUM'] = invoiceNumber;
    options['PAYMENTREQUEST_0_TRANSACTIONID'] = transactionId;
...
PaypalExpress.prototype.doExpressCheckoutPayment = function (token, payerId, ipnURL, callback) {
    if (typeof token !== 'undefined' && token !== '') {
        //Set required request parameters
        ...
        // Is this neccessary? ? ?
        //options['PAYMENTREQUEST_0_ITEMAMT'] = ipnURL;
